...
(defun color-theme-dark-vee ()
  ...
  (color-theme-install
   '(color-theme-dark-vee
     ...
     (default ((t (:stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 116 :width normal ))))
     ...
     (custom-variable-tag ((t (:bold t :foreground "light blue" :weight bold :height 1.2))))
